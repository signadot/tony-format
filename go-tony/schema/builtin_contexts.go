...
//
// The match and patch contexts list each mergeop operator under the name it is
// registered by, in the contexts its symbol says it serves (IsMatch, IsPatch);
// TestOpContextsAgreeWithRegistry holds them to that (addsgv1yh12kszdxmdn0).
func (r *ContextRegistry) registerBuiltinContexts() {
	...
	matchContext := &Context{
		...
		Tags: map[string]*TagDefinition{
			...
			"all":       {Name: "all", Contexts: []string{"tony-format/context/match", "tony-format/context/patch"}},
			"let":       {Name: "let", Contexts: []string{"tony-format/context/match", "tony-format/context/patch"}},
			"pass":      {Name: "pass", Contexts: []string{"tony-format/context/match", "tony-format/context/patch"}},
			"raw":       {Name: "raw", Contexts: []string{"tony-format/context/match", "tony-format/context/patch"}},
			"get-path":  {Name: "get-path", Contexts: []string{"tony-format/context/match", "tony-format/context/patch"}},
			"list-path": {Name: "list-path", Contexts: []string{"tony-format/context/match", "tony-format/context/patch"}},
			"key":       {Name: "key", Contexts: []string{"tony-format/context/match", "tony-format/context/patch"}},
			"comment":   {Name: "comment", Contexts: []string{"tony-format/context/match", "tony-format/context/patch"}},
		},
	}
	...
	patchContext := &Context{
		...
		Tags: map[string]*TagDefinition{
			...
			"json-patch": {Name: "json-patch", Contexts: []string{"tony-format/context/patch"}},
			...
			"if":         {Name: "if", Contexts: []string{"tony-format/context/patch"}},
			"quote":      {Name: "quote", Contexts: []string{"tony-format/context/patch"}},
			"unquote":    {Name: "unquote", Contexts: []string{"tony-format/context/patch"}},
			"all":        {Name: "all", Contexts: []string{"tony-format/context/match", "tony-format/context/patch"}},
			"field":      {Name: "field", Contexts: []string{"tony-format/context/match", "tony-format/context/patch"}},
			"pass":       {Name: "pass", Contexts: []string{"tony-format/context/match", "tony-format/context/patch"}},
			"get-path":   {Name: "get-path", Contexts: []string{"tony-format/context/match", "tony-format/context/patch"}},
