...
func (l *TCPListener) Serve() error {
	l.server.Spec.Log.Info("docd TCP listener started", "addr", l.listener.Addr().String())
...
func (l *TCPListener) handleConnection(conn net.Conn) {
	...
	sessionID := fmt.Sprintf("docd-%d", seq)
...
func (l *TCPListener) Close() error {
	...
	l.server.Spec.Log.Info("docd TCP listener stopped")
	return nil
}
